...
<div class="container">
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['submit'])) {
        ...
        $cost = $_POST['estimate-cost'];
        $repair = $_POST['estimate-repair'];
        $detail = $_POST['estimate-detail'];

        $sql = "INSERT INTO estimate (Claim_ID, Employee_ID, Cost, Repairability, Detail) VALUES ('$cid','$eid','$cost','$repair','$detail')";
